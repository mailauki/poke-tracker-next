...
import { createTheme, ThemeProvider, useMediaQuery, CssBaseline, useTheme, Button, TextField } from '@mui/material'
      ...
      <main className={styles.main}>
        {!session ? (
          <div style={{ padding: '50px 0 100px 0' }}>
            <Auth supabaseClient={supabase} appearance={{ theme: authTheme }} theme={theme.palette.mode} />
          </div>
        ) : (
          !open ? (
            <>
